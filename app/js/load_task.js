...
function processingTag(param, task_id) {
    ...
    processElement.classList.add("flex", "flex-row", "items-center", "justify-end", "px-4", "gap-2", "w-full");
